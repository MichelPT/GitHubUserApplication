...
class ProfileListAdapter : ListAdapter<ItemsItem, ProfileListAdapter.ItemViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val binding: ProfileItemBinding = ProfileItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ItemViewHolder (private val binding: ProfileItemBinding) : RecyclerView.ViewHolder(binding.root) {
